...
`,fs=({headers:e=[],label:t})=>{const{formatMessage:o}=(0,k.A)();return(0,s.jsxs)(C.s,{children:[(0,s.jsx)(C.s,{width:he,height:ie,shrink:0,alignItems:"center",paddingLeft:6,children:(0,s.jsx)(M.o,{variant:"sigma",textColor:"neutral500",children:o({id:"Settings.roles.form.permission.property-label",defaultMessage:"{label} permissions"},{label:t})})}),e.map(n=>n.isActionRelatedToCurrentProperty?(0,s.jsx)(C.s,{width:w,shrink:0,justifyContent:"center",children:(0,s.jsx)(M.o,{variant:"sigma",textColor:"neutral500",children:o({id:`Settings.roles.form.permissions.${n.label.toLowerCase()}`,defaultMessage:n.label})})},n.label):(0,s.jsx)(C.s,{width:w,shrink:0},n.label))]})},se=e=>(0,S.css)`
  ${M.o} {
...
`,Cs=({onClick:e,className:t,hasConditions:o=!1,variant:n="tertiary"})=>{const{formatMessage:r}=(0,k.A)();return(0,s.jsx)(xs,{hasConditions:o,className:t,children:(0,s.jsx)(B.$,{variant:n,startIcon:(0,s.jsx)(ze.A,{}),onClick:e,children:r({id:"global.settings",defaultMessage:"Settings"})})})},xs=(0,S.default)(y.a)`
  ...
  `}
`,ae=(0,S.default)(Cs)``,Be=({actions:e=[],headerBreadCrumbs:t=[],isFormDisabled:o,onClosed:n,onToggle:r})=>{const{formatMessage:a}=(0,k.A)(),{availableConditions:d,modifiedData:i,onChangeConditions:l}=Y(),c=j.useMemo(()=>Object.entries(ue(d,"category")),[d]),p=e.filter(({isDisplayed:h,hasSomeActionsSelected:f,hasAllActionsSelected:O})=>h&&Boolean(f||O)),[g,m]=j.useState(_s(p,i,c)),x=(h,f)=>{m((0,je.Ay)(O=>{O[h]||(O[h]={}),O[h].default||(O[h].default={}),O[h].default=f}))},_=()=>{const h=Object.entries(g).reduce((f,O)=>{const[P,L]=O,E=Object.values(L).reduce((b,T)=>({...b,...T}),{});return f[P]=E,f},{});l(h),r()};return(0,s.jsxs)($.k,{labelledBy:"condition-modal-breadcrumbs",onClose:n,children:[(0,s.jsx)(K.r,{children:(0,s.jsx)(es.B,{id:"condition-modal-breadcrumbs",label:t.join(", "),children:t.map((h,f,O)=>(0,s.jsx)(ss.m,{isCurrent:f===O.length-1,children:ts(a({id:h,defaultMessage:h}))},h))})}),(0,s.jsxs)(le.c,{children:[p.length===0&&(0,s.jsx)(M.o,{children:a({id:"Settings.permissions.conditions.no-actions",defaultMessage:"You first need to select actions (create, read, update, ...) before defining conditions on them."})}),(0,s.jsx)("ul",{children:p.map(({actionId:h,label:f,pathToConditionsObject:O},P)=>{const L=O.join("..");return(0,s.jsx)(js,{arrayOfOptionsGroupedByCategory:c,label:f,isFormDisabled:o,isGrey:P%2===0,name:L,onChange:x,value:A(g,L,{})},h)})})]}),(0,s.jsx)(de.j,{startActions:(0,s.jsx)(B.$,{variant:"tertiary",onClick:r,children:a({id:"app.components.Button.cancel",defaultMessage:"Cancel"})}),endActions:(0,s.jsx)(B.$,{onClick:_,children:a({id:"Settings.permissions.conditions.apply",defaultMessage:"Apply"})})})]})},_s=(e,t,o)=>e.reduce((n,r)=>{const a=A(t,[...r.pathToConditionsObject,"conditions"],{}),d=o.reduce((i,l)=>{const[c,p]=l,g=p.reduce((m,x)=>(m[x.id]=A(a,x.id,!1),m),{});return i[c]=g,i},{});return n[r.pathToConditionsObject.join("..")]=d,n},{}),js=({arrayOfOptionsGroupedByCategory:e,isFormDisabled:t=!1,isGrey:o=!1,label:n,name:r,onChange:a,value:d})=>{const{formatMessage:i}=(0,k.A)(),l=c=>{a&&a(r,Es(e,c))};return(0,s.jsxs)(C.s,{as:"li",background:o?"neutral100":"neutral0",paddingBottom:3,paddingTop:3,children:[(0,s.jsxs)(C.s,{paddingLeft:6,style:{width:180},children:[(0,s.jsxs)(M.o,{variant:"sigma",textColor:"neutral600",children:[i({id:"Settings.permissions.conditions.can",defaultMessage:"Can"}),"\xA0"]}),(0,s.jsx)(M.o,{variant:"sigma",title:n,textColor:"primary600",ellipsis:!0,children:i({id:`Settings.roles.form.permissions.${n.toLowerCase()}`,defaultMessage:n})}),(0,s.jsxs)(M.o,{variant:"sigma",textColor:"neutral600",children:["\xA0",i({id:"Settings.permissions.conditions.when",defaultMessage:"When"})]})]}),(0,s.jsx)(y.a,{style:{maxWidth:430,width:"100%"},children:(0,s.jsx)(Ne.B,{id:r,customizeContent:(c=[])=>`${c.length} currently selected`,onChange:l,value:ys(d),options:Os(e),disabled:t})})]})},ys=e=>Object.values(e).map(t=>Object.entries(t).filter(([,o])=>o).map(([o])=>o)).flat(),Os=e=>e.reduce((t,[o,n])=>(t.push({label:re(o),children:n.map(r=>({label:r.displayName,value:r.id}))}),t),[]),Es=(e,t)=>e.map(([,o])=>o).flat().reduce((o,n)=>({[n.id]:t.includes(n.id),...o}),{}),bs=({actions:e=[],isFormDisabled:t,pathToData:o,subjects:n=[]})=>{const[r,a]=j.useState(null),d=i=>()=>{a(r===i?null:i)};return(0,s.jsx)(s.Fragment,{children:n.map(({uid:i,label:l,properties:c},p)=>{const g=r===i,m=e.map(x=>({...x,isDisplayed:Array.isArray(x.subjects)&&x.subjects.indexOf(i)!==-1}));return(0,s.jsxs)(C.s,{direction:"column",display:"inline-flex",minWidth:"100%",borderColor:"primary600",borderWidth:g?1:0,children:[(0,s.jsx)(Ms,{availableActions:m,isActive:g,isGrey:p%2===0,isFormDisabled:t,label:l,onClickToggle:d(i),pathToData:[o,i].join("..")}),g&&c.map(({label:x,value:_,children:h})=>(0,s.jsx)(as,{availableActions:m,childrenForm:h,isFormDisabled:t,label:x,pathToData:[o,i].join(".."),propertyName:_},_))]},i)})})},Ms=({availableActions:e=[],isActive:t=!1,isGrey:o=!1,isFormDisabled:n=!1,label:r,onClickToggle:a,pathToData:d})=>{const[i,l]=j.useState(!1),{formatMessage:c}=(0,k.A)(),{modifiedData:p,onChangeParentCheckbox:g,onChangeSimpleCheckbox:m}=Y(),x=()=>{l(b=>!b)},_=()=>{l(!1)},h=A(p,d.split(".."),{}),f=j.useMemo(()=>Object.keys(h).reduce((b,T)=>(b[T]=ye(h[T],"conditions"),b),{}),[h]),{hasAllActionsSelected:O,hasSomeActionsSelected:P}=J(f),L=j.useMemo(()=>As(e,p,d),[e,p,d]),E=L.some(b=>b.hasConditions);return(0,s.jsxs)(Ps,{isActive:t,children:[(0,s.jsxs)(Ie,{height:ie,flex:1,alignItems:"center",background:o?"neutral100":"neutral0",children:[(0,s.jsx)(Le,{isCollapsable:!0,isFormDisabled:n,label:r,checkboxName:d,onChange:g,onClick:a,someChecked:P,value:O,isActive:t,children:(0,s.jsx)(We,{paddingLeft:2,children:t?(0,s.jsx)(Qe.A,{}):(0,s.jsx)(qe.A,{})})}),(0,s.jsx)(C.s,{style:{flex:1},children:L.map(({actionId:b,hasSomeActionsSelected:T,isDisplayed:v,...I})=>{if(!v)return(0,s.jsx)(me,{},b);const{hasConditions:W,hasAllActionsSelected:R,isParentCheckbox:Z,checkboxName:G,label:te}=I;return Z?(0,s.jsxs)(ke,{justifyContent:"center",alignItems:"center",children:[W&&(0,s.jsx)(y.a,{as:"span",position:"absolute",top:"-6px",left:"37px",width:"6px",height:"6px",borderRadius:"20px",background:"primary600"}),(0,s.jsx)(D.J,{disabled:n,name:G,"aria-label":c({id:"Settings.permissions.select-by-permission",defaultMessage:"Select {label} permission"},{label:`${te} ${r}`}),onValueChange:U=>{g({target:{name:G,value:U}})},indeterminate:T,value:R})]},b):(0,s.jsxs)(ke,{justifyContent:"center",alignItems:"center",children:[W&&(0,s.jsx)(y.a,{as:"span",position:"absolute",top:"-6px",left:"37px",width:"6px",height:"6px",borderRadius:"20px",background:"primary600"}),(0,s.jsx)(D.J,{disabled:n,indeterminate:W,name:G,onValueChange:U=>{m({target:{name:G,value:U}})},value:R})]},b)})}),i&&(0,s.jsx)(Be,{headerBreadCrumbs:[r,"Settings.permissions.conditions.conditions"],actions:L,isFormDisabled:n,onClosed:_,onToggle:x})]}),(0,s.jsx)(y.a,{transform:"translateY(10px)",right:"9px",position:"absolute",children:(0,s.jsx)(ae,{onClick:x,hasConditions:E})})]})},As=(e,t,o)=>e.map(({actionId:n,isDisplayed:r,applyToProperties:a,label:d})=>{if(!r)return{actionId:n,hasSomeActionsSelected:!1,isDisplayed:r};const i=[...o.split(".."),n],l=Q(a)?[...i,"properties","enabled"]:i,c=A(t,[...i,"conditions"],null),p={actionId:n,checkboxName:l.join(".."),hasConditions:X(c).some(_=>_),isDisplayed:r,label:d,pathToConditionsObject:i};if(Q(a)){const _=A(t,l,!1);return{...p,hasAllActionsSelected:_,hasSomeActionsSelected:_,isParentCheckbox:!1}}const g=A(t,l,null),{hasAllActionsSelected:m,hasSomeActionsSelected:x}=J(g);return{...p,hasAllActionsSelected:m,hasSomeActionsSelected:x,isParentCheckbox:!0}}),fe=(e,t)=>`
  ${Ie} {
